...
function AnonyScene({ play, common }: { play: boolean; common: { animate: TargetAndTransition; transition: Transition } }) {
  ...
  return <>
    ...
    <motion.circle r="9" fill="rgba(225,255,188,.98)" animate={play ? { cx: [170, 360, 550], cy: [160, 245, 145], opacity: [0, 1, 0] } : { opacity: .6, cx: 360, cy: 245 }} transition={{ duration: 5.5, repeat: Infinity, ease: "easeInOut" }} />
  </>;
}
