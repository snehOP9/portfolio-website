    ...
    <motion.div style={reduceMotion ? undefined : { opacity, scale, y }} className="relative z-20 mx-auto h-full max-w-[1800px]">
      <div className="grid h-full gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(420px,.82fr)] lg:items-center">
        <div className="flex flex-col justify-center space-y-7 xl:space-y-10">
          <motion.div style={reduceMotion ? undefined : { y: eyebrowY }} {...entrance(.08)} className="flex items-center gap-3 font-mono text-xs tracking-[.16em] text-signal"><span className="h-px w-10 bg-signal opacity-70" /> Data â†’ models â†’ systems</motion.div>
          ...
          <motion.p {...entrance(.36)} className="flex max-w-2xl flex-wrap items-center gap-x-2 gap-y-1 font-mono text-xs leading-relaxed tracking-[.06em] text-foreground/70 sm:gap-x-3">
            <span className="whitespace-nowrap">AI / ML Ã— Software Engineering</span><span aria-hidden="true">Â·</span><span className="whitespace-nowrap">Chandigarh University</span><span aria-hidden="true">Â·</span><span className="whitespace-nowrap">B.Tech CSE</span><span aria-hidden="true">Â·</span><span className="whitespace-nowrap">2023â€“2027</span>
          </motion.p>
          ...
          <motion.div {...entrance(.66)} className="flex flex-wrap items-center gap-x-5 gap-y-3 font-mono text-xs tracking-[.1em] text-muted-foreground">
            <a href="https://github.com/snehOP9" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition-colors hover:text-foreground"><span aria-hidden="true">â†—</span>GITHUB</a>
            <a href="https://www.linkedin.com/in/sneh-raunak/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition-colors hover:text-foreground"><span aria-hidden="true">â†—</span>LINKEDIN</a>
          </motion.div>
        </div>
