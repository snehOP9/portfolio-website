...
**Thesis:** a dark instrumentation surface where data becomes a distinct S, then becomes systems and evidence.

- **Base:** near-black green-charcoal, warm white type, one acid-lime signal color (`#c6ff72`).
- **Type:** Syne for compressed editorial headings; Inter for readable body copy; monospace for system metadata.
